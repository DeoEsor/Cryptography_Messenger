...
public sealed class AsymmetricEncryptorContext
{
    private ushort Seed;
    
    private CipherModeBase Mode;
    	
    public AsymmetricEncryptorContext(CipherMode.Mode mode, 
    	ushort seed, 
    	IAsymmetricEncryptor asymmetricEncryptor, params object[] parameters)
    {
    	Mode = CipherMode.CreateInstance(mode, asymmetricEncryptor, parameters);
    	Seed = seed;
    }
